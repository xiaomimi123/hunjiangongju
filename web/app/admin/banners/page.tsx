...
export default function BannersPage() {
  ...
  function validateForm(): string {
    if (!form.title.trim() || form.title.trim().length > 60) return '标题为 1-60 字'
    if (form.body.trim().length > 200) return '正文最多 200 字'
  ...
  return (
    <div className="space-y-5">
      <PageHeader title="公告 Banner" subtitle="首页顶部滚动公告：新增、上下架、排序" />
